...
=================== 2차 코드 리뷰 =====================
총평 
    - 중간중간 자잘한 조건 놓치긴 했지만 쉽게 찾을 수 있던 실수들이라 다시 안풀어봐도 될 문제. 
    - 1차 때보다 실수가 줄었다.? 
    - 1차 코드보다 좀 더 함수화를 덜 하고, 조금은..(?) 더 깔끔해진 것 같기도
    - 변수명 헷갈리거나 실수하지 말자. 
    - 그리고 귀찮아도 그냥 코드 다 치자. 절대 반복코드 있어도 복사하지 말자. 나 무조건 복사하면 변수 변경 덜 해서 실수한다. 
"""
